...
export class ContestsService {
  ...
  allContests:Contest[]=  [
    ...
    },
    {
      id: 5,
      name: 'Art Challenge',
      description: 'Participate in an art challenge and showcase your creativity',
    ...
    },
    {
      ...
      description: 'Participate in a cooking challenge and show off your culinary skills',
  ...
  searchContests(query: string){
    return this.allContests.filter((contest)=> contest.name.toLowerCase().includes(query.toLowerCase()))
  }
